...
public class TemplateBuilderTests
{
    ...
    {
        var template = new TemplateBuilder("SampleApp").Add<MemoryMetrics>().Build();
    ...
    {
        var template = new TemplateBuilder("SampleApp").Add<MemoryMetrics>().Add<UsersMetrics>().Build();
    ...
    {
        var template = new TemplateBuilder("SampleApp").AddDiscovery<HealthCheckStatus>("Health").Build();
    ...
    {
        var template = new TemplateBuilder("SampleApp").Add<MemoryMetrics>().NodataTrigger(seconds: 300).Build();
    ...
    {
        var template = new TemplateBuilder("SampleApp").Add<MemoryMetrics>().NodataTrigger(disable: true).Build();
    ...
    {
        var t1 = new TemplateBuilder("SampleApp").Add<MemoryMetrics>().Build();
        var t2 = new TemplateBuilder("SampleApp").Add<MemoryMetrics>().Build();
    ...
    {
        var template = new TemplateBuilder("MyApp").Add<AppMetrics>().Build();
        template.DiscoveryRules.Count.ShouldBe(1);
    ...
    {
        var template = new TemplateBuilder("MyApp").Add<CustomMacroFixture>().Build();
    ...
    {
        var template = new TemplateBuilder("SampleApp").Add<UsersMetrics>().Build();
    ...
    {
        var template = new TemplateBuilder("SampleApp").Add<PieChartMemoryMetrics>().Build();
