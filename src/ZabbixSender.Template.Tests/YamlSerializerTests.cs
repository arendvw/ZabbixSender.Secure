...
public class YamlSerializerTests
{
    ...
    {
        var template = new TemplateBuilder<TestPayload>().Add<UsersMetrics>().Build();
    ...
    {
        var template = new TemplateBuilder<TestPayload>().AddDiscovery<HealthCheckStatus>("Health").Build();
        var yaml = YamlSerializer.ToYaml(template);
